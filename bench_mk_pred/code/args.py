...
class ArgReader():
    ...
    def __init__(self,argv):
        ...
        self.parser.add_argument('--num_workers', type=int,metavar='NUMWORKERS',
                            ...
                            the same as any n, but you’ll only have a single worker, so it might be slow',default=8)
        ...
        self.parser.add_argument('--multi_gpu', type=str2bool, metavar='S',
                            help='If cuda is true, run the computation with multiple gpu',default=True)
